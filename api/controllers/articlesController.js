...
module.exports.sendmail = function (req, res, next) {
  ...
  const output = `<p>A new inquiry</p>
                  ...
                  <ul>
                  <li>Regarding: ${req.body.email}</li>
                  <li>email: ${req.body.fullName}</li>
                  <li>Phone: ${req.body.message}</li>
                  <li>Question: ${req.body.number}</li>
                  </ul>
  `
  async function main() {
    console.log(a);
  ...
  let info = await transporter.sendMail({
    ...
    to: 'aasshey@seojs.co', // list of receivers
    subject: "seojs.co Inquiry", // Subject line
    text: "Below is the information filled by the user on seojs.co", // plain text body
